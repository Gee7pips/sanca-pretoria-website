      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-0 left-0 sm:bottom-6 sm:left-6 z-50 w-full sm:w-[380px] flex flex-col rounded-t-2xl sm:rounded-2xl shadow-premium-xl overflow-hidden bg-white"
