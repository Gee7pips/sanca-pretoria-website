...
const stats = [
  {
    ...
    glowColor: 'group-hover:shadow-sanca-green/10',
  },
  {
    icon: Users,
    value: 1000,
    ...
    glowColor: 'group-hover:shadow-sanca-gold/10',
  },
  {
    icon: Building2,
    value: 4,
    ...
    glowColor: 'group-hover:shadow-sanca-emerald/10',
  },
  {
    icon: Award,
    value: 100,
    ...
    glowColor: 'group-hover:shadow-sanca-green-dark/10 dark:group-hover:shadow-sanca-gold/10',
  },
  {
    icon: Clock,
    value: 7,
